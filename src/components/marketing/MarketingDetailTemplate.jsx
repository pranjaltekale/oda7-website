    ...
    <div className="marketing-detail-page">
          ...
          <div className="detail-hero-grid">
            <div className="detail-hero-copy">
              ...
              <div className="detail-hero-actions">
                ...
                <Button onClick={onOpenDemo} variant="secondary" size="lg" iconLeft="PlayCircle">See ODA7 in action</Button>
              </div>
      ...
      <section className="section-wrapper">
        <div className="container-wide real-scenario-grid">
          <div className="real-scenario-image"><img src="/oda7-team-story.jpg" loading="lazy" decoding="async" alt="An Indian sales operations team collaborating in a modern office" /><span>Real work. Shared context.</span></div>
