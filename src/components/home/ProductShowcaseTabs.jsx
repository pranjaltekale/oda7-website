        ...
        <div style={{ maxWidth: '1180px', margin: '0 auto' }}>
          {activeTab === 'sales' && (
            <div className="animate-fadeIn">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', color: 'var(--oda-text-secondary)', fontSize: '0.85rem' }}>
          ...
          {activeTab === 'agency' && (
            <div className="animate-fadeIn">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', color: 'var(--oda-text-secondary)', fontSize: '0.85rem' }}>
                ...
                <span className="badge badge-cyan">Visible compensation context</span>
              </div>
              ...
              <div className="dashboard-mockup-frame">
                ...
                <div style={{ padding: '24px', background: 'var(--oda-surface)', fontSize: '0.8125rem' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px', marginBottom: '20px' }}>
                    <div style={{ background: 'var(--oda-bg-alt)', border: '1px solid var(--oda-border)', borderRadius: '8px', padding: '16px' }}>
                      <div style={{ color: 'var(--oda-text-muted)', fontSize: '0.7rem', textTransform: 'uppercase', marginBottom: '4px' }}>Earned Commissions (This Month)</div>
                      <div style={{ fontSize: '1.5rem', fontWeight: '800', color: 'var(--oda-success)' }}>$42,850.00</div>
                      <div style={{ color: 'var(--oda-success)', fontSize: '0.75rem', marginTop: '2px' }}>100% verified across 412 closed deals</div>
                    </div>
                    <div style={{ background: 'var(--oda-bg-alt)', border: '1px solid var(--oda-border)', borderRadius: '8px', padding: '16px' }}>
                      <div style={{ color: 'var(--oda-text-muted)', fontSize: '0.7rem', textTransform: 'uppercase', marginBottom: '4px' }}>Active Floor Contests</div>
                      <div style={{ fontSize: '1.5rem', fontWeight: '800', color: 'var(--oda-primary)' }}>3 Live Battles</div>
                      <div style={{ color: 'var(--oda-text-secondary)', fontSize: '0.75rem', marginTop: '2px' }}>Weekend Sprint: $2,500 Prize Pool</div>
                    </div>
                    <div style={{ background: 'var(--oda-bg-alt)', border: '1px solid var(--oda-border)', borderRadius: '8px', padding: '16px' }}>
                      <div style={{ color: 'var(--oda-text-muted)', fontSize: '0.7rem', textTransform: 'uppercase', marginBottom: '4px' }}>Shift Attendance Rate</div>
                      <div style={{ fontSize: '1.5rem', fontWeight: '800', color: '#fbbf24' }}>98.4%</div>
                      <div style={{ color: 'var(--oda-success)', fontSize: '0.75rem', marginTop: '2px' }}>24 Reps clocked in on time</div>
                    </div>
                  </div>
                  <div style={{ background: 'var(--oda-bg-alt)', border: '1px solid var(--oda-border)', borderRadius: '10px', padding: '16px' }}>
                    <div style={{ fontWeight: '700', color: 'var(--oda-text-primary)', marginBottom: '10px' }}>Itemized Rep Payroll & Payslip Dispatch</div>
                    <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 1fr 120px', padding: '8px 12px', background: 'var(--oda-surface)', borderRadius: '6px', color: 'var(--oda-text-muted)', fontSize: '0.75rem', fontWeight: '600', border: '1px solid var(--oda-border)' }}>
                      <span>Rep Name</span>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', marginTop: '6px' }}>
                      <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 1fr 120px', padding: '8px 12px', borderRadius: '6px', background: 'var(--oda-surface)', border: '1px solid var(--oda-border-subtle)', color: 'var(--oda-text-primary)', alignItems: 'center' }}>
                        <span>Alex Rivera (Tier 1 SDR)</span>
                        <span>$4,000.00</span>
                        <span style={{ color: 'var(--oda-success)', fontWeight: '700' }}>+$3,420.00</span>
                        <span style={{ fontWeight: '700' }}>$7,420.00</span>
                        <span style={{ textAlign: 'right', color: 'var(--oda-primary)', cursor: 'pointer', fontWeight: '600' }}>Download PDF</span>
                      </div>
                      <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr 1fr 120px', padding: '8px 12px', borderRadius: '6px', background: 'var(--oda-surface)', border: '1px solid var(--oda-border-subtle)', color: 'var(--oda-text-primary)', alignItems: 'center' }}>
                        <span>Marcus Chen (Enterprise AE)</span>
                        <span>$5,500.00</span>
                        <span style={{ color: 'var(--oda-success)', fontWeight: '700' }}>+$4,800.00</span>
