...
export const PlatformPage = ({ onOpenDemo }) => (
  <div style={{ paddingTop: '20px', paddingBottom: '100px' }}>
    ...
    <section className="container-wide page-reveal" style={{ paddingBottom: '80px' }}><ProductUIFrame title="Platform overview" steps={['Capture', 'Connect', 'Execute', 'Measure', 'Improve']} icon="Layers" /></section>
