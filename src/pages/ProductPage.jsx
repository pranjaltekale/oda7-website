...
export const ProductPage = ({ onOpenDemo }) => (
  <div style={{ paddingTop: '20px', paddingBottom: '100px' }}>
    ...
    <section className="detail-final-cta"><div className="container-narrow"><span className="section-eyebrow">Try the workflow</span><h2>See how the modules move together.</h2><p>Follow an illustrative lead from arrival through calling, follow-up and manager visibility.</p><div><Button onClick={onOpenDemo} size="lg" iconLeft="PlayCircle">See ODA7 in action</Button><Button to="/platform" variant="secondary" size="lg" iconRight="ArrowRight">Explore the platform</Button></div></div></section>
  </div>
);
