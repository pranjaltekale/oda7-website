...
export const SolutionsPage = ({ onOpenDemo }) => (
  <div>
    ...
    <section className="container-wide page-reveal" style={{ paddingBottom: 'clamp(24px, 3.5vw, 44px)' }}><ScenarioStoryboardVisual /></section>
