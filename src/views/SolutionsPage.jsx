...
import { ScenarioStoryboardVisual } from '../components/visuals/ScenarioStoryboardVisual';
...
export const SolutionsPage = ({ onOpenDemo }) => (
  <div style={{ paddingTop: '20px', paddingBottom: '100px' }}>
    ...
    <section className="container-wide page-reveal" style={{ paddingBottom: '80px' }}><ScenarioStoryboardVisual /></section>
    ...
    <section className="detail-final-cta"><div className="container-narrow"><span className="section-eyebrow">See the handoffs</span><h2>Experience how the roles move together.</h2><p>Open the interactive workflow or start mapping your organization with ODA7.</p><div><Button demo size="lg" iconLeft="PlayCircle">See ODA7 in action</Button><Button to="/get-started" variant="secondary" size="lg" iconRight="ArrowRight">Get started</Button></div></div></section>
  </div>
);
