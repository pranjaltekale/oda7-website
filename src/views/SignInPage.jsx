  ...
  <div style={{ paddingTop: '20px', paddingBottom: '110px' }}>
    ...
    <div className="container-narrow page-reveal" style={{ textAlign: 'center' }}>
      <div className="card-saas signin-card" style={{ maxWidth: '620px', margin: '0 auto', padding: '42px' }}>
        ...
        <p style={{ color: 'var(--oda-text-secondary)', fontSize: '0.9rem', lineHeight: 1.65, marginBottom: '24px' }}>You’ll leave this product story and continue at oda7.com.</p>
        <div style={{ display: 'flex', justifyContent: 'center', flexWrap: 'wrap', gap: '12px' }}>
          <Button href="https://oda7.com/sign-in?next=%2Fdashboard" variant="primary" iconRight="ArrowRight">Continue to sign in</Button>
          <Button demo variant="secondary" iconLeft="PlayCircle">Try the product demo</Button>
        </div>
      </div>
    </div>
  </div>
